...
public interface HotelRepository extends JpaRepository<HotelEntity, Long>{
	...
	@Query("SELECT v.idHotel FROM HotelEntity v JOIN FETCH VueloEntity d On v.ciudad.idCiudad = d.destino.idCiudad WHERE (:nombreHotel is null or v.nombreHotel = :nombreHotel) " +
