...
public interface HotelRepository extends JpaRepository<HotelEntity, Long>{
	...
	@Query("SELECT v FROM HotelEntity v JOIN FETCH VuelosEntity d On v.ciudad.idCiudad = d.destino.idCiudad WHERE (:nombreHotel is null or v.nombreHotel = :nombreHotel) " +
